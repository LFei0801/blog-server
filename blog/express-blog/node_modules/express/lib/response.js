...
res.jsonp = function jsonp(obj) {
  ...
  const spaces = app.get('json spaces');
  const body = stringify(val, replacer, spaces, escape)
  const callback = this.req.query[app.get('jsonp callback name')];
...
/**
 * Add `field` to consty. If already present in the consty set, then
...
res.consty = function(field){
  // checks for back-compat
  if (!field || (Array.isArray(field) && !field.length)) {
    deprecate('res.consty(): Provide a field name');
    return this;
  }
